    ...
    <footer className="bg-[var(--primary-1)] relative w-full left-0 bottom-0 ">
      <section className="max-w-6xl mx-auto">
        <div className="flex-col flex xl:flex-row gap-5 items-center justify-between border-b border-b-gray-500 p-10">
          <div className="flex items-center">
            <AppImage
              ...
              height={50}
            />
            <h2 className="text-[26px] mr-3 text-[var(--primary-3)] font-bold">
              الوصل
            </h2>
          </div>
          ...
          <div className="w-50">
            <button className="py-4 w-full px-8 bg-[var(--primary-1)] font-bold text-[20px] text-white rounded-4xl border border-indigo-550 transition cursor-pointer hover:bg-white hover:text-[var(--primary-1)]">
              إبدأ الآن
            </button>
          </div>
        </div>
        ...
        <p className="text-center text-[var(--primary-3)] text-[18px] py-5">
          كل الحقوق محفوظة لصالح شركة الوصل ديفيلوب @2026
        </p>
      </section>
    </footer>
  );
